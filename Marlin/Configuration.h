...
#define STRING_CONFIG_H_AUTHOR "(miggles, rrg)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Miggles Print Shit"
...
// This One #define AUTO_BED_LEVELING_LINEAR
